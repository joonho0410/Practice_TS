...
type MakeNumberRange<End, Ary extends any[] = []> = Ary['length'] extends End
  ? [Ary['length'], ...Ary][number]
  : MakeNumberRange<End, [Ary['length'], ...Ary]>

type NumberRange<L, H> = L | Exclude<MakeNumberRange<H>, MakeNumberRange<L>>
